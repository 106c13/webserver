...
void ServerManager::startBodyReading(Connection& conn) {
...
void ServerManager::processFixedBody(Connection& conn) {
    Request& req = conn.req;
...
void ServerManager::processChunkedBody(Connection& conn) {
    Request& req = conn.req;
    Buffer& buf = conn.buffer;
...
void ServerManager::processBody(Connection& conn) {
